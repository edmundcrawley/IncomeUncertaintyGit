...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/CSTW_tran_denmark.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/CSTW_tran_denmark_pref.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/CSTW_perm_denmark.png}
\includegraphics[scale=0.45]{\econtexRoot/Figures/CSTW_perm_denmark_pref.png}
...
\begin{align*}
\text{MPX}_{\text{model}} = \frac{1}{4}\sum_{i=0}^{3}(1-\text{MPX}_q)^i \text{MPX}_q
\end{align*}
where $\text{MPX}_q$ is the partial derivative in the quarterly model.
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/MPC_accuracy.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/DurableBias.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/MPXByDurables_nodurableproxy.png}
...
\subsection{Persistent Consumption Response}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/Robust_tranMPX_liquidwealth.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/Robust_tranMPX_URE.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/Logs_tranMPX_liquidwealth.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/Logs_tranMPX_URE.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/total_tranMPX_URE.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/DivPerm_tranMPX_liquidwealth.png}
...
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/Spouse_tranMPX_liquidwealth.png}
...
\section{Distribution of Permanent and Transitory MPX by URE, NNP and Income} \label{PermMPXbyURENNP}
\begin{figure} 
	\begin{centering}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/PermTranMPXByURE_level_lincome_head.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/PermTranMPXByNNP_level_lincome_head.png}
		\includegraphics[scale=0.45]{\econtexRoot/Figures/PermTranMPXByIncome_level_lincome_head.png}
		\caption{MPX Distribution by URE, NNP and Income}
		\label{fig:MPCAuclertPermTran}
	\end{centering}
\end{figure}
