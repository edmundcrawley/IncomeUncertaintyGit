...
Here we show that the estimate of a group's MPX obtained only from the median level of liquid wealth in the group is, for all practical purposes, the same as that obtained from running our full estimation procedure on that group. This allows us to plausibly extend our analysis beyond Denmark to measure the extent of MPX heterogeneity in the United States.
