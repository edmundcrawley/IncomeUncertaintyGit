...
\begin{document}\bibliographystyle{\econtexBibStyle}
	...
	***************\\
	...
	\begin{figure}
		\centering
		\includegraphics[scale=0.4]{\figdir/NW_predict_from_Liquid.pdf}
		\centering
		\includegraphics[scale=0.4]{\figdir/URE_predict_from_Liquid.pdf}
	...
	\begin{center}
		\begin{table}
			...
			\begin{center}
				\input \tabdir/prediction_errors.tex
			\end{center}
		\end{table}
	\end{center}
