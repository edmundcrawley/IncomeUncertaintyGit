...
We have assumed that idiosyncratic risk remains constant over time. Given that our sample period covers the great recession, this may not be appropriate. In appendix *********** we show how the variance of income growth has varied over time, peaking just after the crisis in 2010. We also show that our MPX estiamtes are unbiased if transitory variance is increasing linearly over time, and show the degree to which transitory variance changed over the sample period will only introduce a small bias to our MPX estimates.
