...
\begin{center}
	\input\econtexRoot/Tables/experimental/psi_laborsupply.tex		\captionof{table}{Simulation estimates of $\psi$ with varying preference shocks and Frisch elasticity}
	\label{table:psi_laborsupply}
\end{center}
