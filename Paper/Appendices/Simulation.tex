...
\begin{center}
	\input Code/PrefShockModel/Tables/Psi_array1.tex	\input Code/PrefShockModel/Tables/Psi_array2.tex
	\captionof{table}{Estimates of $\psi$}
	\label{table:simulation_psi}
\end{center}

\begin{center}
	\input Code/PrefShockModel/Tables/Phi_array1.tex	\input Code/PrefShockModel/Tables/Phi_array2.tex
...
\begin{comment}
\begin{center}
	\input Code/PrefShockModel/Tables/sigmap_array1.tex	\input Code/PrefShockModel/Tables/sigmap_array2.tex
	\captionof{table}{Estimates of $\sigma_p$} \label{table:simulation_sigma_p}
\end{center}
\begin{center}
	\input Code/PrefShockModel/Tables/sigmaq_array1.tex	\input Code/PrefShockModel/Tables/sigmaq_array2.tex
