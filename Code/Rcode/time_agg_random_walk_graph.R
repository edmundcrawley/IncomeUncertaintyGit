...
legend(1.0,1.0, legend=c("f(t),  Path of Transitory Income Shock", ""),col=c("black","white"),lty=1,lwd=4,bty="n",cex=1.65)
...
legend(1.0,1.0, legend=c("f(t),  Path of Transitory Income Shock", "g(t), Path of Consuption Response"),col=c("black","red"),lty=1,lwd=4,bty="n", cex=1.65)
