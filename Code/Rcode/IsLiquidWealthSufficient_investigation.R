...
for (i in 1:10){
  ...
  Inc_MPC_predict_by_decile_median[i]    = MPC_tran_predict_from_pctile(weighted.mean(SCF_data$liq_pctile[SCF_data$inc_decile==i], SCF_data$wgt[SCF_data$inc_decile==i]))
