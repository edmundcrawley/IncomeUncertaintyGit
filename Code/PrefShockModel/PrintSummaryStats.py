...
output += "\\\\ Pension Funds \\footnote{We also include special savings such as educations funds here.}     & "    + mystr3(URENNP_data[3,0]) + " & " + mystr1(URENNP_data[3,1]) + " & "+ mystr1(URENNP_data[3,2]) + " & "+ mystr2(URENNP_data[3,3]) + " & "+ mystr2(URENNP_data[3,4])  + " \n"
...
output += "\\\\ \\bottomrule  \n"
output += "\end{tabular}}\n"
output += "\\\\ \\textbf{Notes}: NNP and URE numbers are in billions of 2015 USD. \n"
output += "\end{minipage}\n"
