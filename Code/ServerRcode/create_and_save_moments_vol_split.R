###########################################################################
# 
# Split by income volatility and private / non-private employment
# 
...
###############################################################################
# 
# At least 3 years of private employment
# 
###############################################################################

empirical_input_file="input_for_R_fullsample_level_lincome_pri.csv"
tag = "_level_lincome_pri"
...
for(quantile_type in c("liquid_wealth_quantile")){
  ...
  this_moment = paste('moments_by_',quantile_type,'$quantiles',sep ="")
  this_file = paste(moments_dir,'moments_pri_by_',quantile_type,'_quantiles','.txt',sep ='')
  write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
  
  for(i in 1:num_quantiles){
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','c_vector',sep ="")
    this_file = paste(moments_dir,'moments_pri_by_',quantile_type,i,'c_vector','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
    
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','omega',sep ="")
    this_file = paste(moments_dir,'moments_pri_by_',quantile_type,i,'_omega','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
    
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','delta_y_var',sep ="")
    this_file = paste(moments_dir,'moments_pri_by_',quantile_type,i,'_delta_y_var','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
...
# Less than 3 years of private employment
empirical_input_file="input_for_R_fullsample_level_lincome_nonpri.csv"
tag = "_level_lincome_nonpri"
...
for(quantile_type in c("liquid_wealth_quantile")){
  ...
  this_moment = paste('moments_by_',quantile_type,'$quantiles',sep ="")
  this_file = paste(moments_dir,'moments_nonpri_by_',quantile_type,'_quantiles','.txt',sep ='')
  write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
  
  
  for(i in 1:num_quantiles){
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','c_vector',sep ="")
    this_file = paste(moments_dir,'moments_nonpri_by_',quantile_type,i,'c_vector','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
    
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','omega',sep ="")
    this_file = paste(moments_dir,'moments_nonpri_by_',quantile_type,i,'_omega','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
    
    this_moment = paste('moments_by_',quantile_type,'$X',i,'$','delta_y_var',sep ="")
    this_file = paste(moments_dir,'moments_nonpri_by_',quantile_type,i,'_delta_y_var','.txt',sep ='')
    write.table(eval(parse(text = this_moment)),file = this_file,row.names = FALSE, col.names = FALSE, na ="",sep =',')
