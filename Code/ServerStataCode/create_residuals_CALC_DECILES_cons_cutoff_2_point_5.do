...
log using "${logfiles}\Cons_cutoff_2_point_5", text replace
...
global drop_top = "97.5"
global drop_bottom = "2.5"
...
global drop_top_change = "97.5"
global drop_bottom_change = "2.5"
...
xtset id year
	...
	outsheet using "${savedirectory}\input_for_R_fullsample_level${lab_inc_tag}_cons_2_5.csv",comma replace
	}
restore
